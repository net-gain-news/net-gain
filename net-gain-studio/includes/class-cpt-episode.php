	...
	public static function register() {
		register_post_type(
			...
			array(
				...
				// generic wp/v2/ng_episode route silently no-ops. No UI side effect
				// here: show_ui is false, so there's no post-edit screen for a Custom
				// Fields metabox to appear on.
